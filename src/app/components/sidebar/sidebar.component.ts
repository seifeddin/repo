...
//     { path: '/user-profile', title: 'User Profile',  icon:'person', class: '', active:false, type:'dropdown',submenus:[ {path: '/user-profile', title: 'User Profile1',  icon:'person', class: '', },{path: '/user-profile', title: 'User Profile2',  icon:'person', class: '', }] },
...
//   animations:[
//       trigger('slide',[state('up', style({ height: 0 })),
